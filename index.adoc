...
|laptop|192.168.122.1|Ansible Server/Hypervisor|8 Cores|16GB|256GB SSD
...
----
jduncan@dhcp-192-168-1-140 ~$ cat /etc/hosts
...
.deploy our playbook.
----
jduncan@dhcp-192-168-1-140 uscbp_containers$ ansible-playbook kube_3_node_demo.yaml
----
...
----
jduncan@dhcp-192-168-1-140 ~$ mkdir -p certs && openssl req \
...
----
jduncan@dhcp-192-168-1-140 ~$ sudo docker tag docker.io/jeduncan/soscleaner kube1.example.com:5000/soscleaner
jduncan@dhcp-192-168-1-140 ~$ sudo docker push kube1.example.com:5000/soscleaner
----

==== Stateless as a Practical Solution
